...
Use the `pro` conda env (Python 3.11). pandas and requests are already installed. For notebooks 10–11:

```bash
conda install matplotlib seaborn duckdb -c conda-forge
```
...
01–08 is Python fluency. 09–11 is what a data analyst actually does: clean a table, join it, plot it, and query it.
